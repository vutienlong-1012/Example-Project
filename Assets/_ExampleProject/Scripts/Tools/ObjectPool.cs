...
namespace ExampleProject.Tools
{
    ...
    public static class ObjectPoolExtensions
    {
        ...
        public static void DelayRecycle(this GameObject obj, MonoBehaviour mono, float _time)
        {
            mono.StartCoroutine(IEDelay(obj, _time));
        }

        static IEnumerator IEDelay(this GameObject obj, float time)
        {
